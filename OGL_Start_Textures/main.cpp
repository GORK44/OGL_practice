...
int main()
{
    ...
    //========================================================================
    Shader ourShader("/书/OpenGLtest1/vertexSource.txt", "/书/OpenGLtest1/fragmentSource.txt");
    //========================================================================
    ...
    glGenTextures(1, &texture); //生成 1 个纹理，保存ID到texture
    glBindTexture(GL_TEXTURE_2D, texture); // 绑定纹理，接下来所有GL_TEXTURE_2D操作都是对此纹理
...
//    stbi_set_flip_vertically_on_load(true); // tell stb_image.h to flip loaded texture's on the y-axis.
    unsigned char *data = stbi_load("/书/OpenGLtest1/container.jpg", &width, &height, &nrChannels, 0);
    if (data)
    {
